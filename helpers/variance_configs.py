...
SCORING_CONFIGS: list[dict[str, Any]] = [
    ...
    # ══ EV charging-focused / routing-focused ═════════════════════════════
    ...
    # -- congestion focus (high EV wait + high utilization) ----------------
    {
        "name": "congestion_low",
    ...
    # -- SLA-throughput tradeoff (high deadline + high utilization) --------
    {
    ...
    # -- geographic spread focus (high detour + high station wait) ---------
    {
        "name": "spread_low",
        "EV_METRIC_WEIGHTS":      {"path_deviation": 15, "delta_arrival": 1,  "ev_wait_time": 3,  "missed_deadline": 2},
        "STATION_METRIC_WEIGHTS": {"utilization": 1,     "expected_wait_time": 15},
    ...
    # -- punctuality focus (high arrival delay + high deadline) ------------
    {
    ...
    # -- low detour, heavy charging penalty --------------------------------
    {
